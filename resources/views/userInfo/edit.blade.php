<x-app-layout>
    ...
    @section('content')
        ...
        <div class="container">
            <form id="updateUserInfo" enctype="multipart/form-data" method="POST" action="/userInfo/{{ $userInfo->id }}">
                @csrf
                @method('PUT')
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="first_name" id="first_name" class="form-control"
                            placeholder="First Name" value="{{ $userInfo->first_name }}">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="gender" id="gender" class="form-select">
                            <option value="" disabled {{ !$userInfo->gender ? 'selected' : '' }}>Select Gender
                            </option>
                            ...
                            <option value="None" {{ $userInfo->gender == 'None' ? 'selected' : '' }}>Not Specified
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone_number" id="phone_number" class="form-control"
                            placeholder="Phone Number" value="{{ $userInfo->phone_number }}">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="bio" id="bio" cols="30" rows="3" class="form-control"
                            placeholder="Write something about yourself...">{{ $userInfo->bio }}</textarea>
                    </div>
                </div>
